#############################################################################
# Makefile for building: build/CplusplusPiano.app/Contents/MacOS/CplusplusPiano
# Generated by qmake (3.1) (Qt 6.9.3)
# Project:  CplusplusPiano.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile CplusplusPiano.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CplusplusPiano1.0.0
DISTDIR = /Users/maxcui/Downloads/CplusplusPiano/build/obj/CplusplusPiano1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -L/opt/homebrew/opt/portaudio/lib -lportaudio -framework QtWidgets -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework IOKit -framework DiskArbitration -framework UniformTypeIdentifiers -framework OpenGL   
...
EXPORT__QMAKE_STASH_ = /Users/maxcui/Downloads/CplusplusPiano/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/maxcui/Downloads/CplusplusPiano/CplusplusPiano.pro
...
build/CplusplusPiano.app/Contents/MacOS/CplusplusPiano:  $(OBJECTS)  
	@test -d build/CplusplusPiano.app/Contents/MacOS/ || mkdir -p build/CplusplusPiano.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: CplusplusPiano.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile CplusplusPiano.pro
...
build/CplusplusPiano.app/Contents/PkgInfo: 
	@test -d build/CplusplusPiano.app/Contents || mkdir -p build/CplusplusPiano.app/Contents
	@$(DEL_FILE) build/CplusplusPiano.app/Contents/PkgInfo
	@echo "APPL????" > build/CplusplusPiano.app/Contents/PkgInfo
build/CplusplusPiano.app/Contents/Info.plist: 
	@test -d build/CplusplusPiano.app/Contents || mkdir -p build/CplusplusPiano.app/Contents
	@$(DEL_FILE) build/CplusplusPiano.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.CplusplusPiano,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.CplusplusPiano,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,CplusplusPiano,g" -e "s,@LIBRARY@,CplusplusPiano,g" -e "s,\$${EXECUTABLE_NAME},CplusplusPiano,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >build/CplusplusPiano.app/Contents/Info.plist

all: Makefile \
		build/CplusplusPiano.app/Contents/PkgInfo \
		build/CplusplusPiano.app/Contents/Info.plist build/CplusplusPiano.app/Contents/MacOS/CplusplusPiano
...
distclean: clean 
	-$(DEL_FILE) -r build/CplusplusPiano.app
